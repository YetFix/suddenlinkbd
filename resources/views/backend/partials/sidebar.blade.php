     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/sales"
                         aria-expanded="false">
                         <i class="fas fa-address-book"></i>
                 ...
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/customers"
                         aria-expanded="false">
                         <i class="fas fa-address-book"></i>
                         <span class="hide-menu">Cusomers</span>
                     </a>
                 </li>
                 <li class="sidebar-item">
                 ...
                 <li class="sidebar-item">
                     <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/" target="_blank"
                         ...
                         <span class="hide-menu">Go to Suddenlinkbd</span>
                     </a>
                 </li>
                 <li class="sidebar-item">
